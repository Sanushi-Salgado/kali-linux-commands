...
> Click on any link below to access its detailed **installation instructions, commands, and usage examples**.

## 📂 Repo Structure

- [Basics](./basics) - Core concepts & commands
...
- [Tools](./tools) - Tools that can be installed in Kali Linux with individual READMEs for each tool
	...
	- [Ffuf](./tools/ffuf.md)  	
	- [Gawk](./tools/gawk.md)   
	- [Github-Endpoints](./tools/github-endpoints.md) 
	- [Github-Subdomains](./tools/github-subdomains.md) 
	- [Gitlab-Subdomains](./tools/gitlab-subdomains.md) 
	- [GNU Parallel](./tools/gnu-parallel.md) 
	- [Gowitness](./tools/gowitness.md)  
	- [Gplaydl](./tools/gplaydl.md)   	
	- [Httpx](./tools/httpx.md)  
	- [JADX](./tools/jadx.md)   	
	- [KnockKnock](./tools/knock-knock.md)
	- [Postgre-SQL](./tools/postgre-sql.md) 
