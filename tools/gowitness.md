...
```bash
gowitness version											# 🛠️ Get the installed gowitness version

gowitness --help 											# ❓ Get help information for Gowitness

gowitness scan --help										# ❓ Get help information for Gowitness	scan option	

gowitness scan single --help								# ❓ Get help information for Gowitness single scan option
```
